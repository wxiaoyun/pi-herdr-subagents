...
export const BUILTIN_PROFILES: Profile[] = [
	{
		...
		description: "General agent with all tools. Research, multi-step tasks, code changes. Can spawn any subagent.",
		promptMode: "append",
		allowedSubagents: "all",
	},
	{
		name: "Worker",
		description: "Implementation agent with all tools. Executes a well-specified task end to end. May spawn Scout only.",
		promptMode: "append",
...
export function loadProfiles(cwd: string, agentDir = getAgentDir()): Map<string, Profile> {
